    ...
    <label className="block">
      ...
      <div className="relative">
        <input
          ...
          className={`mt-2 w-full bg-transparent border-0 border-b-2 border-ink/20 px-0 py-3 text-lg font-sans text-ink placeholder:text-ink/30 focus:outline-none focus:border-[#056ef5] transition-colors${isPassword ? " pr-8" : ""}`}
        />
        {isPassword && (
          <button
            type="button"
